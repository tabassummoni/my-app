...
const MakeUpPro = ({ makeUpProduct }) => {
  const { _id, name, price, url, image, details } = makeUpProduct;
      ...
      <div className="card bg-base-100 lg:w-80 shadow-sm border-2 rounded-lg border-red-300">
        ...
        <div className="">
          ...
          <div className="card-actions justify-end">
            <Link to={`/makeUpCare/${_id}`} >   <button className="h-11 w-20 mt-4 bg-white text-pink-950 font-bold border-4 border-pink-950 mr-20 mb-2">Details </button>
