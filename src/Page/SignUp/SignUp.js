...
//Google SignIn
    ...
    return (
        ...
        <div className='lg:w-96 lg:h-96 md:w-52 md:h-44 h-20 w-44 lg:mt-32 lg:ml-52 md:ml-72 '>
            <Lottie  animationData={signUpLottieData}></Lottie>   
   </div>
             <div className='lg:mr-96 ml-36'>
<form onSubmit={handleSignUp} >
   <div class="  px-7 mb-6 lg:ml-24 ">
       <h1 className='text-center mt-7 text-2xl border-b-4 border-pink-950 text-white ' >𝑺𝒊𝒈𝒏𝑼𝒑</h1>
      <div>
...
<div className='divider'>OR</div>
       <button onClick={handleGoogleSignIn} className='justify-evenly ml-28 mb-2 text-white w-32 bg-pink-950 lg:w-80  focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm  sm:w-auto px-5 py-2.5 text-center'>𝐒𝐢𝐠𝐧𝐔𝐩 𝐰𝐢𝐭𝐡 𝐆𝐨𝐨𝐠𝐥𝐞 </button>
