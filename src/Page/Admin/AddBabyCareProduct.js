...
const AddBabyCareProduct = () => {
 ...
 const addNewBabyCareProducts = {
        ...
        fetch('https://my-app-server-liard.vercel.app/babyCosmetics',{
            ...
            body: JSON.stringify(addNewBabyCareProducts)
        })
            .then(res => res.json())
        .then(data => {
            console.log(data);
    ...
    return (
        <div>
                 <form onSubmit={handleAddBabyCareProduct} class="max-w-3xl mx-auto p-6 bg-black rounded-2xl shadow-lg space-y-4">
  <h2 class="text-2xl font-semibold text-gray-300 underline">𝐀𝐝𝐝 𝐀 𝐍𝐞𝐰 𝐁𝐚𝐛𝐲 𝐂𝐚𝐫𝐞 𝐏𝐫𝐨𝐝𝐮𝐜𝐭</h2>
  <div>
...
export default AddBabyCareProduct;