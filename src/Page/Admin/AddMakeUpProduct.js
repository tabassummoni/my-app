...
const AddMakeUpProduct = () => {
 ...
 const addNewMakeUpProducts = {
        ...
        fetch('https://my-app-server-phi.vercel.app/makeupcosmetics',{
            ...
            body: JSON.stringify(addNewMakeUpProducts)
        })
            .then(res => res.json())
        .then(data => {
            console.log(data);
    ...
    return (
        <div>
                 <form onSubmit={handleAddMakeUpProduct} class="max-w-3xl mx-auto p-6 bg-black rounded-2xl shadow-lg space-y-4">
  <h2 class="text-2xl font-semibold text-gray-300 underline">𝐀𝐝𝐝 𝐀 𝐍𝐞𝐰 𝐌𝐚𝐤𝐞𝐔𝐩 𝐏𝐫𝐨𝐝𝐮𝐜𝐭</h2>
  <div>
